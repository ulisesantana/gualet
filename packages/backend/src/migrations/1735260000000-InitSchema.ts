...
export class InitSchema1735260000000 implements MigrationInterface {
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ALTER TABLE "transactions"
        DROP CONSTRAINT "FK_86e965e74f9cc66149cf6c90f64"
    `);
    ...
    await queryRunner.query(`
      ALTER TABLE "categories"
        DROP CONSTRAINT "FK_13e8b2a21988bec6fdcbb1fa741"
    `);
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE "categories" (
        ...
        "type" character varying NOT NULL DEFAULT 'OUTCOME',
        "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
        "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
        "userId" uuid,
    ...
    await queryRunner.query(`
      CREATE TABLE "transactions" (
        ...
        "operation" character varying NOT NULL DEFAULT 'OUTCOME',
    ...
    await queryRunner.query(`
      ALTER TABLE "categories"
        ADD CONSTRAINT "FK_13e8b2a21988bec6fdcbb1fa741"
        FOREIGN KEY ("userId")
        REFERENCES "users"("id")
        ON DELETE CASCADE
        ON UPDATE NO ACTION
    ...
    await queryRunner.query(`
      ALTER TABLE "payment_methods"
        ADD CONSTRAINT "FK_580f1dbf7bceb9c2cde8baf7ff4"
        FOREIGN KEY ("userId")
        REFERENCES "users"("id")
        ON DELETE CASCADE
        ON UPDATE NO ACTION
    ...
    await queryRunner.query(`
      ALTER TABLE "transactions"
        ADD CONSTRAINT "FK_50db78fa73cb72af407852b6db9"
    ...
    await queryRunner.query(`
      ALTER TABLE "user_preferences"
        ADD CONSTRAINT "FK_user_preferences_defaultPaymentMethodId"
